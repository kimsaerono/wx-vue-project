<template>
  <div class="page">
    ...
    <mt-button size="large" type="primary" @click="buyTicket($event)" :data-price="price">购票</mt-button>
    <mt-popup
...
<script>
  ...
  import { getUserInfo,queryCityTicketPrice,randomString } from '../../main'
...
//      },
      getListName(listData){
        ...
        let lineId = this.$route.query.lineId,
            ...
            self.direction = this.$route.query.direction;
        var listArr = [];
